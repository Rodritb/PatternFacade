...
#define UE_PROJECT_NAME PatronFacade
#define UE_TARGET_NAME PatronFacadeEditor
#define UE_MODULE_NAME "PatronFacade"
...
#define PATRONFACADE_API DLLEXPORT
